...
var TELEGRAM_BOT_TOKEN = "TELEGRAM BOT TOKEN";
var TELEGRAM_CHAT_ID   = "TELEGRAM ID";
...
function prosesPenilaianEssayMasal(quizId) {
  ...
  for (var sUid in submitData) {
    ...
    if (answersObj._essayGraded) continue; // Lewati jika sudah dinilai AI (hemat kuota)
...
// Menggunakan GEMINI_API_KEY dari konfigurasi global di atas
// ============================================================
